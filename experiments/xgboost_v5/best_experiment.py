"""xgboost_v5 deepen iter10 -- on iter9 (top10 sub-models KEPT), bump n_est to 5000.

Anchor chain: v4 W''''' -> iter9 (top10 sub-models, kept).
...
RECIPE_VARIANT = "deepen_iter10_top10_nest5000"
PARAMS_SUMMARY = (
