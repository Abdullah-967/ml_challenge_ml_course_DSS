"""xgboost_v5 deepen iter9 -- single knob: extend per-type sub-models top5 -> top10.

Anchor: v4 W''''' (smoke 1-3, deepen 4-8 reverted/tied).
v4 iter23 went from 2 to 5 types (-57 lift); next-tier types may add more.
Sub-types are derived dynamically: top 10 by sample count in train fold,
with min_count=200 floor (drop sparse types regardless of rank).
"""
...
RECIPE_VARIANT = "deepen_iter9_top10_submodels"
PARAMS_SUMMARY = (
