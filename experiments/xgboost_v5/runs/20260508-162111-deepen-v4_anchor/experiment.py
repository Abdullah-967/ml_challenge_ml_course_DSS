"""xgboost_v5 deepen iter11 -- mechanically-paired knob lr=0.04 + n_est=6250.

Anchor chain: v4 W''''' -> iter9 (top10) -> iter10 (n_est=5000) KEPT.
Single mechanically-paired knob: lr=0.04 + n_est=6250 (lr * n_est = 250 = same
step budget as iter10's 0.05 * 5000 = 250). All else identical.
"""
...
RECIPE_VARIANT = "deepen_iter11_lr04_nest6250"
PARAMS_SUMMARY = (
    "XGBRegressor(reg:absoluteerror,n_est=6250,lr=0.04,max_depth=6,"
    "mcw=5,subsample=0.8,colsample=0.6,reg_lambda=1.0,hist,enable_categorical=True),"
    "0.7*global+0.3*submodel(top10_types_min200,n_est=6250,lr=0.04)"
)
