"""xgboost_v5 deepen iter12 -- BLEND ratio 0.3 -> 0.4 on iter10 anchor.

Anchor chain: v4 W''''' -> iter9 (top10) -> iter10 (n_est=5000) KEPT.
Single knob: BLEND 0.3 -> 0.4. Sub-model gets more weight in final blend.
"""
...
RECIPE_VARIANT = "deepen_iter12_blend04"
PARAMS_SUMMARY = (
    ...
    "0.6*global+0.4*submodel(top10_types_min200,n_est=5000)"
)
