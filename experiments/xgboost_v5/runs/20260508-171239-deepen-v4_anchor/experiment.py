"""xgboost_v5 deepen iter13 -- subsample 0.8 -> 0.7 on iter10 anchor.

Anchor chain: v4 W''''' -> iter9 (top10) -> iter10 (n_est=5000) KEPT.
Single knob: subsample 0.8 -> 0.7. Lower subsample = more stochasticity per tree
= potentially better generalization in saturated capacity regime.
"""
...
RECIPE_VARIANT = "deepen_iter13_subsample07"
PARAMS_SUMMARY = (
    "XGBRegressor(reg:absoluteerror,n_est=5000,lr=0.05,max_depth=6,"
    "mcw=5,subsample=0.7,colsample=0.6,reg_lambda=1.0,hist,enable_categorical=True),"
