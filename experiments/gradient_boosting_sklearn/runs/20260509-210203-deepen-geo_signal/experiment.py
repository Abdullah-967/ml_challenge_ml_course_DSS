...
RECIPE_VARIANT = "deepen_iter12_drop_room_layout"
PARAMS_SUMMARY = (
    "GBR(loss=absolute_error,n_est=100,lr=0.1,max_depth=4,subsample=0.8),"
    "geo_signal,commune_te(k=20),drop_room_layout"
)
...
DROP_FROM_NUMERIC = {
    ...
    "commune_codes",
    "cadastral_sections",
    # iter12: drop sparse room-layout columns (gated by property_type, mostly zero)
