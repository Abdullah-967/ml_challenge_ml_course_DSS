...
RECIPE_VARIANT = "ablate_c4_drop_reg_lambda"
PARAMS_SUMMARY = (
    "XGBRegressor(reg:absoluteerror,n_est=500,lr=0.05,max_depth=6,"
    "min_child_weight=5,subsample=0.9,colsample_bytree=0.7,reg_lambda=1.0,"
    "tree_method=hist,enable_categorical=True),"
    "geo+ratios+date+property_type_cat"
)
...
CATEGORICAL_COLUMNS = ("commune_first", "cadastral_first", "property_type")
