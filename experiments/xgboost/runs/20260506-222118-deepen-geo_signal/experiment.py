...
RECIPE_VARIANT = "deepen2_derived_ratios"
PARAMS_SUMMARY = (
    ...
    "geo_signal+ratios(built_per_premise,land_per_lot,commercial_share,"
...
def make_feature_frame(records, numeric_columns, categorical_columns, category_levels):
    frame = add_derived_ratios(add_geo_features(pd.DataFrame(records)))
    numeric_part = (
