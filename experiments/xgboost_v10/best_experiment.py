"""xgboost_v10 smoke iter2 -- shrunk v6 anchor (no transfer).

Smoke-shrunk variant of v6's promoted recipe: top5 sub-models (vs 15) and
n_est=2000 (vs 5000) so each smoke runs under the 5-min budget. Same
architecture and feature set otherwise. This re-establishes the anchor at
smoke speed; Lane 3 will add the transfer features and measure the lift.
"""
...
RECIPE_VARIANT = "smoke_iter2_shrunk_v6_anchor"
PARAMS_SUMMARY = (
