"""xgboost_v6 smoke lane B -- v4 W''''' plus parcel numeric components.
...
RECIPE_VARIANT = "smoke_laneB_v4_parcel_numeric_components"
PARAMS_SUMMARY = (
    "XGBRegressor(reg:absoluteerror,n_est=3000,lr=0.05,max_depth=6,"
    "mcw=5,subsample=0.8,colsample=0.6,reg_lambda=1.0,hist,enable_categorical=True),"
    "0.7*global+0.3*submodel(top5_types,n_est=3000)"
)
...
def fit_predict(train_records, validation_records):
    ...
    # Identify property_type per row in train and val
