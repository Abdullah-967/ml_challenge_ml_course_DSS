"""xgboost_v6 deepen iter1 -- single knob: extend per-type sub-models top5 -> top15.

Anchor: v4 W'''''.
v5 top10 gave a small lift; this tests whether the next tier adds more.
Sub-types are derived dynamically: top 15 by sample count in train fold,
...
RECIPE_VARIANT = "deepen_iter1_top15_submodels"
PARAMS_SUMMARY = (
    ...
    "0.7*global+0.3*submodel(top15_types_min200,n_est=4000)"
)
