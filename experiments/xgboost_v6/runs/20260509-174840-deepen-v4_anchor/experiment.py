"""xgboost_v6 deepen iter3 -- top15 sub-models plus n_estimators=6000.

Anchor: v6 deepen iter2 (top15 sub-models, n_est=5000).
Single knob: n_estimators 5000 -> 6000 in both global and sub-models.
"""
...
RECIPE_VARIANT = "deepen_iter3_top15_nest6000"
PARAMS_SUMMARY = (
    "XGBRegressor(reg:absoluteerror,n_est=6000,lr=0.05,max_depth=6,"
    "mcw=5,subsample=0.8,colsample=0.6,reg_lambda=1.0,hist,enable_categorical=True),"
    "0.7*global+0.3*submodel(top15_types_min200,n_est=6000)"
)
