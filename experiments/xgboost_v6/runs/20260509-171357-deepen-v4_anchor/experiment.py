"""xgboost_v6 deepen iter2 -- top15 sub-models plus n_estimators=5000.

Anchor: v6 deepen iter1 (top15 sub-models, n_est=4000).
Single knob: n_estimators 4000 -> 5000 in both global and sub-models.
"""
...
RECIPE_VARIANT = "deepen_iter2_top15_nest5000"
PARAMS_SUMMARY = (
    ...
    "0.7*global+0.3*submodel(top15_types_min200,n_est=5000)"
)
