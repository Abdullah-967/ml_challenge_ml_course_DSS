...
RECIPE_VARIANT = "deepen_iter30_gamma_1"
PARAMS_SUMMARY = (
    "XGBRegressor(reg:absoluteerror,n_est=500,lr=0.05,max_depth=6,"
    "mcw=5,subsample=0.8,colsample=0.6,reg_lambda=1.0,gamma=1.0,hist,enable_categorical=True),"
    "0.7*global+0.3*submodel(top5_types,gamma=1.0)"
)
