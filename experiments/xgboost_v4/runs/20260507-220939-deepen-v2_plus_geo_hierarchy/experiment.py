...
RECIPE_VARIANT = "deepen_iter7_built_rel_dept"
PARAMS_SUMMARY = (
...
def fit_predict(train_records, validation_records):
    ...
    dept_means, dept_global = compute_group_mean_map(train_pre, "dept_code", "built_area")
    train_pre = add_relative_feature(train_pre, "dept_code", "built_area", "built_rel_dept", dept_means, dept_global)
    val_pre = add_relative_feature(val_pre, "dept_code", "built_area", "built_rel_dept", dept_means, dept_global)
