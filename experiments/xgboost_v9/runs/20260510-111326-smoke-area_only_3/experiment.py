"""xgboost_v9 smoke iter2 -- pure-area triplet.

Premise: same XGB recipe as smoke iter1, single knob = swap feature set to
three pure-area features (built_area, land_area, house_area). Tests whether
size dimensions alone (no count features) carry enough signal at the 3-feature
limit.
"""
...
RECIPE_VARIANT = "smoke_iter2_area_only_3"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist),area_only_3=[built_area,land_area,house_area]"
)

NUMERIC_COLUMNS = ("built_area", "land_area", "house_area")
