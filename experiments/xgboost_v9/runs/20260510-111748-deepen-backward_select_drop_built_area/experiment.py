...
RECIPE_VARIANT = "deepen_iter2_drop_built_area"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist),pool9_drop_built_area=[land_area,house_area,"
    "apartment_area,num_lots,num_commercial,num_apt_2_rooms,"
    "num_house_2_rooms,year,month]"
)
