...
RECIPE_VARIANT = "deepen_iter1_anchor_pool10"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist),pool10=[built_area,land_area,house_area,apartment_area,"
    "num_lots,num_commercial,num_apt_2_rooms,num_house_2_rooms,year,month]"
)
