"""xgboost_v7 deepen iter1 -- n_estimators=8000 capacity probe.

Anchor: v7 smoke lane C (top15 sub-models, n_est=7000).
Single knob: n_estimators 7000 -> 8000 in both global and sub-models.
"""
...
RECIPE_VARIANT = "deepen_iter1_nest8000"
PARAMS_SUMMARY = (
