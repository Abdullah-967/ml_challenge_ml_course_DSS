"""xgboost_v7 smoke lane B -- lower submodel blend weight.

Anchor: v6 promoted recipe (top15 sub-models, n_est=6000, blend=0.3).
Single knob: BLEND 0.3 -> 0.2.
"""
...
RECIPE_VARIANT = "smoke_laneB_blend02"
PARAMS_SUMMARY = (
    ...
    "0.8*global+0.2*submodel(top15_types_min200,n_est=6000)"
)
