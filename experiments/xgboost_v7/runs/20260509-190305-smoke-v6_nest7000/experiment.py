"""xgboost_v7 smoke lane C -- n_estimators=7000 capacity probe.

Anchor: v6 promoted recipe (top15 sub-models, n_est=6000).
Single knob: n_estimators 6000 -> 7000 in both global and sub-models.
"""
...
RECIPE_VARIANT = "smoke_laneC_nest7000"
PARAMS_SUMMARY = (
    "XGBRegressor(reg:absoluteerror,n_est=7000,lr=0.05,max_depth=6,"
    "mcw=5,subsample=0.8,colsample=0.6,reg_lambda=1.0,hist,enable_categorical=True),"
    "0.7*global+0.3*submodel(top15_types_min200,n_est=7000)"
)
