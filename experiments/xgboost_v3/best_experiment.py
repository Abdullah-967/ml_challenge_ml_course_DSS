"""xgboost_v3 stage 4 confirm -- seed=2026 of W''' (deepen iter9 winner).

W''' recipe: max_depth=2 + colsample_bytree=1.0 on baseline_three_only features.
"""
...
PARAMS_SUMMARY = (
    ...
    "tree_method=hist),baseline_three_only,seed=2026"
)
