"""xgboost_v3 deepen iter8 -- single knob: max_depth=3.

Carry-forward W': deepen_iter6 (cv 62402.52, max_depth=4, colsample=1.0).
Push Occam direction: depth 4 -> 3.
"""
...
RECIPE_VARIANT = "deepen_iter8_max_depth_3"
PARAMS_SUMMARY = (
    "XGBRegressor(reg:absoluteerror,n_est=500,lr=0.05,max_depth=3,"
