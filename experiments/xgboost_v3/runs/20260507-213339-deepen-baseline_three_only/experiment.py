"""xgboost_v3 deepen iter7 -- single knob: subsample=1.0.

Carry-forward W': deepen_iter6 (cv 62402.52, max_depth=4, colsample=1.0).
This iter sets subsample=0.8 -> 1.0.
"""
...
RECIPE_VARIANT = "deepen_iter7_subsample_full"
PARAMS_SUMMARY = (
    "XGBRegressor(reg:absoluteerror,n_est=500,lr=0.05,max_depth=4,"
    "min_child_weight=5,subsample=1.0,colsample_bytree=1.0,reg_lambda=1.0,"
