"""xgboost_v3 ablate a2 -- revert colsample_bytree=1.0 to default 0.8 (keep max_depth=2).

Tests whether colsample_bytree=1.0 (deepen iter6) was load-bearing in W'''.
"""
...
RECIPE_VARIANT = "ablate_a2_revert_colsample"
PARAMS_SUMMARY = (
