"""xgboost_v3 deepen iter4 -- single knob: max_depth=4.

Carry-forward: smoke_iter1 (cv 62517.15).
Reduce tree depth from 6 to 4 -- regularize for feature-starved 3-feature setup.
"""
...
RECIPE_VARIANT = "deepen_iter4_max_depth_4"
PARAMS_SUMMARY = (
