"""xgboost_v3 deepen iter2 -- single knob: monotonic constraints.

Carry-forward: smoke_iter1 (cv 62517.15) -- iter1 log1p reverted.
This iter sets monotone_constraints=(1,1,1) for (built_area, num_lots, num_commercial).
"""
...
RECIPE_VARIANT = "deepen_iter2_monotone_constraints"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,monotone=(1,1,1)),baseline_three_only"
)
