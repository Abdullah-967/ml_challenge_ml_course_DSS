"""xgboost_v11 smoke iter2 -- shrunk v6 anchor at n_est=1000 (no velocity).

Re-establishes the v6 anchor at runtime-safe smoke speed. Same recipe as
v10 deepen iter1 but as a fresh family-level smoke baseline so Lane 3 can
measure the velocity-feature lift cleanly.
"""
...
RECIPE_VARIANT = "smoke_iter2_shrunk_v6_anchor_n1000"
PARAMS_SUMMARY = (
