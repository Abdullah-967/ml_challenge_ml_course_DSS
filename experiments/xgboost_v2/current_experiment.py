"""xgboost_v2 promoted recipe -- W' (seed=42).

Promoted after Stage 4 confirm. 2-seed mean: 49200.72 (seed=42: 49154.01,
seed=2026: 49247.43, |Δ|=93 <<1178 noise threshold).

Recipe: tier1 strong-solo anchor (built_area, house_area,
area_house_5plus_rooms) + land/lots/premises + entity counts + room layout
cluster + date_ordinal + ratios; cats: property_type, commune_first,
cadastral_first, transaction_type; log1p target; XGBRegressor with
colsample_bytree=0.6, max_depth=6, mcw=5, lr=0.05, n_est=500.

Stage 3b ablate findings: commune_first (+1884), cadastral_first (+1369),
land/lots/premises (+1627) are LOAD-BEARING. log1p (+170), date_ordinal
(+246) individually tie; combined drop (+1144) at the edge of tie band so
...
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,enable_categorical=True),W'_promoted"
)
