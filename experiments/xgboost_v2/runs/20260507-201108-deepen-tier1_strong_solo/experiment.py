"""xgboost_v2 deepen iter2 -- single knob: + cadastral_first as native cat.

Carry-forward: deepen_iter1 winner (commune_first kept, 55576.54).
This iter adds cadastral_first (finer geo) on top.
"""
...
RECIPE_VARIANT = "deepen_iter2_add_cadastral_first"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,enable_categorical=True),tier1+commune+cadastral"
)

NUMERIC_COLUMNS = ("built_area", "house_area", "area_house_5plus_rooms")
CATEGORICAL_COLUMNS = ("property_type", "commune_first", "cadastral_first")
