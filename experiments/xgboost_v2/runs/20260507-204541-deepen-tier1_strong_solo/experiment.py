"""xgboost_v2 ablate a1 -- LOO: remove commune_first from cats.

Carry-forward: W' (tune_iter7 colsample=0.6, 49154.01).
This iter drops commune_first to test load-bearing.
"""
...
RECIPE_VARIANT = "ablate_a1_drop_commune_first"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,enable_categorical=True),W'-commune_first"
)
...
CATEGORICAL_COLUMNS = ("property_type", "cadastral_first", "transaction_type")
