"""xgboost_v2 tune iter9 -- single knob: reg_lambda=5.0 (was 1.0).

Carry-forward: W'. More L2 regularization.
"""
...
RECIPE_VARIANT = "tune_iter9_lambda5"
PARAMS_SUMMARY = (
    "XGBRegressor(reg:absoluteerror,n_est=500,lr=0.05,max_depth=6,"
    "min_child_weight=5,subsample=0.8,colsample_bytree=0.6,reg_lambda=5.0,"
    "tree_method=hist,enable_categorical=True),W'+lambda5"
)
