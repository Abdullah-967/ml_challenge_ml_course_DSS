"""xgboost_v2 tune iter2 -- single knob: max_depth=4 (was 6).

Carry-forward: W (deepen iter9, 49264.60). tune_iter1 max_depth=8 reverted.
This iter goes shallower instead.
"""
...
RECIPE_VARIANT = "tune_iter2_max_depth4"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,enable_categorical=True),W+max_depth4"
)
