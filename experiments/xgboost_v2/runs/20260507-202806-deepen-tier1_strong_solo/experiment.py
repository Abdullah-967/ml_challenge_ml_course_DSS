"""xgboost_v2 tune iter1 -- single knob: max_depth=8 (was 6).

Carry-forward: deepen_iter9 W (ratios + log1p + tier1 + geo + ttype +
counts + room_layout + date + ratios). Tune iter1 deepens trees.
"""
...
RECIPE_VARIANT = "tune_iter1_max_depth8"
PARAMS_SUMMARY = (
    "XGBRegressor(reg:absoluteerror,n_est=500,lr=0.05,max_depth=8,"
    "min_child_weight=5,subsample=0.8,colsample_bytree=0.8,reg_lambda=1.0,"
    "tree_method=hist,enable_categorical=True),W+max_depth8"
)
