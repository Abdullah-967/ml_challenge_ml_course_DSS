"""xgboost_v2 confirm seed=2026 -- W' recipe with second seed.

W' = tune_iter7 (49154.01) at seed=42. Confirm with seed=2026 to validate
2-seed mean for promotion gate.

Recipe: tier1_strong_solo (built_area, house_area, area_house_5plus_rooms)
+ land/lots/premises + entity counts + room layout cluster + date_ordinal
+ ratios; cats: property_type, commune_first, cadastral_first,
transaction_type; log1p target wrap; XGBRegressor(reg:absoluteerror,
n_est=500, lr=0.05, max_depth=6, mcw=5, subsample=0.8, colsample_bytree=0.6,
reg_lambda=1.0, hist, enable_categorical=True).
"""
...
RECIPE_VARIANT = "confirm_seed2026"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,enable_categorical=True,random_state=2026),W'_seed2026"
)
