"""xgboost_v2 deepen iter1 -- single knob: + commune_first as native cat.

Anchor: tier1_strong_solo (58757.97). Adding commune first-token as native
xgboost categorical to test geo signal layered onto strong-solo anchor.
"""
...
RECIPE_VARIANT = "deepen_iter1_add_commune_first"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,enable_categorical=True),tier1+commune_first"
)

NUMERIC_COLUMNS = ("built_area", "house_area", "area_house_5plus_rooms")
CATEGORICAL_COLUMNS = ("property_type", "commune_first")
