"""xgboost_v2 deepen iter4 -- single knob: + land_area, num_lots, num_premises.

Carry-forward: deepen_iter3 (transaction_type kept tie, 52889.47).
This iter adds raw count/area numerics: land_area + num_lots + num_premises.
"""
...
RECIPE_VARIANT = "deepen_iter4_add_count_area_numerics"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,enable_categorical=True),tier1+geo+ttype+land/lots/premises"
)
