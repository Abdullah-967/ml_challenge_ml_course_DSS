"""xgboost_v2 tune iter6 -- single knob: subsample=0.6 (was 0.8).

Carry-forward: W. Less data per tree.
"""
...
RECIPE_VARIANT = "tune_iter6_subsample06"
PARAMS_SUMMARY = (
    "XGBRegressor(reg:absoluteerror,n_est=500,lr=0.05,max_depth=6,"
    "min_child_weight=5,subsample=0.6,colsample_bytree=0.8,reg_lambda=1.0,"
    "tree_method=hist,enable_categorical=True),W+subsample06"
)
