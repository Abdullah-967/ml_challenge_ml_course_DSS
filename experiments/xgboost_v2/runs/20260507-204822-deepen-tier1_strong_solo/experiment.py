"""xgboost_v2 ablate a3 -- LOO: remove land_area, num_lots, num_premises.

Carry-forward: W'. Drops the 3 raw count/area numerics.
"""
...
RECIPE_VARIANT = "ablate_a3_drop_land_lots_premises"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,enable_categorical=True),W'-land/lots/premises"
)
