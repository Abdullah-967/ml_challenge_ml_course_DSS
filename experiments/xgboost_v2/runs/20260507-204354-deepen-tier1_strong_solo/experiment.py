"""xgboost_v2 tune iter10 -- single knob: reg_alpha=1.0 (was 0).

Carry-forward: W'. Add L1 regularization.
"""
...
RECIPE_VARIANT = "tune_iter10_alpha1"
PARAMS_SUMMARY = (
    "XGBRegressor(reg:absoluteerror,n_est=500,lr=0.05,max_depth=6,"
    "min_child_weight=5,subsample=0.8,colsample_bytree=0.6,reg_lambda=1.0,reg_alpha=1.0,"
    "tree_method=hist,enable_categorical=True),W'+alpha1"
)
