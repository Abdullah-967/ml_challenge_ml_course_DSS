"""xgboost_v2 deepen iter9 -- single knob: + 5 derived ratios.

Carry-forward: deepen_iter8 (log1p kept tie, 49393.96).
This iter adds ratios: built_per_premise, land_per_lot, commercial_share,
apt_share, houses_per_premise.
"""
...
RECIPE_VARIANT = "deepen_iter9_add_ratios"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,enable_categorical=True),log1p+ratios"
)
