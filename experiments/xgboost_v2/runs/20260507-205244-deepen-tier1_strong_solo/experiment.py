"""xgboost_v2 ablate a6 -- combined drop log1p + date_ordinal.

Carry-forward: W'. Both are individually tie (a4: +170, a5: +246).
This iter checks whether combined removal still ties or compounds.
If still tie, this becomes the simplified W'' candidate.
"""
...
RECIPE_VARIANT = "ablate_a6_drop_log1p_and_date"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,enable_categorical=True),W'-log1p-date"
)
