"""xgboost_v2 ablate a5 -- LOO: drop date_ordinal.

Carry-forward: W'. Drops date_ordinal numeric.
"""
...
RECIPE_VARIANT = "ablate_a5_drop_date_ordinal"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,enable_categorical=True),W'-date_ordinal"
)
