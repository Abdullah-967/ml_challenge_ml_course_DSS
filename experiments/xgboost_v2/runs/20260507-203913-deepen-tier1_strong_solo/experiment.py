"""xgboost_v2 tune iter7 -- single knob: colsample_bytree=0.6 (was 0.8).

Carry-forward: W. Fewer features per tree.
"""
...
RECIPE_VARIANT = "tune_iter7_colsample06"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,enable_categorical=True),W+colsample06"
)
