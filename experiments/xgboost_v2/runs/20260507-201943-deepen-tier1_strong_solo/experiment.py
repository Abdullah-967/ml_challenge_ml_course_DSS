"""xgboost_v2 deepen iter7 -- single knob: + date_ordinal.

Carry-forward: deepen_iter6 (room layout kept tie, 50441.16).
This iter adds date_ordinal (transaction_date as days since 2014-01-01).
"""
...
RECIPE_VARIANT = "deepen_iter7_add_date_ordinal"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,enable_categorical=True),+date_ordinal"
)
