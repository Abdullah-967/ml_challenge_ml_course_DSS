"""xgboost_v2 ablate a4 -- LOO: revert log1p target.

Carry-forward: W'. Reverts target back to raw scale.
"""
...
RECIPE_VARIANT = "ablate_a4_revert_log1p"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,enable_categorical=True),W'-log1p"
)
