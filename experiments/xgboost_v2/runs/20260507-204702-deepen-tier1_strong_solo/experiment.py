"""xgboost_v2 ablate a2 -- LOO: remove cadastral_first from cats.

Carry-forward: W'. Drops cadastral_first only.
"""
...
RECIPE_VARIANT = "ablate_a2_drop_cadastral_first"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,enable_categorical=True),W'-cadastral_first"
)
...
CATEGORICAL_COLUMNS = ("property_type", "commune_first", "transaction_type")
