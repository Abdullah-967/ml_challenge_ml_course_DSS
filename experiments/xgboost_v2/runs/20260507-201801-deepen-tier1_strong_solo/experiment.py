"""xgboost_v2 deepen iter6 -- single knob: + room layout cluster.

Carry-forward: deepen_iter5 (entity counts kept tie, 50478.41).
This iter adds all remaining room layout numerics (area_house_*, num_house_*,
area_apt_*, num_apt_*) plus apartment_area and num_house_5plus_rooms.
"""
...
RECIPE_VARIANT = "deepen_iter6_add_room_layout_cluster"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,enable_categorical=True),+room_layout_cluster"
)
