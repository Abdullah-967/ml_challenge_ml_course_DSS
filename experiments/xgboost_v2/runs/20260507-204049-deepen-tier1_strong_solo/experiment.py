"""xgboost_v2 tune iter8 -- single knob: colsample_bytree=1.0 (was 0.6).

Carry-forward: W' (colsample=0.6 kept tie, 49154.01). Test the other
direction now that colsample emerged as a useful knob.
"""
...
RECIPE_VARIANT = "tune_iter8_colsample10"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,enable_categorical=True),W+colsample10"
)
