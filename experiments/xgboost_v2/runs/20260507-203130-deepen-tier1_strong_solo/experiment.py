"""xgboost_v2 tune iter3 -- single knob: lr=0.03, n_est=1000.

Carry-forward: W. Slower learning rate with more trees.
"""
...
RECIPE_VARIANT = "tune_iter3_lr03_nest1000"
PARAMS_SUMMARY = (
    "XGBRegressor(reg:absoluteerror,n_est=1000,lr=0.03,max_depth=6,"
    "min_child_weight=5,subsample=0.8,colsample_bytree=0.8,reg_lambda=1.0,"
    "tree_method=hist,enable_categorical=True),W+lr03_n1000"
)
