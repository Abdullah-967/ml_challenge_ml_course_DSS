"""xgboost_v2 tune iter4 -- single knob: min_child_weight=2 (was 5).

Carry-forward: W. Less regularization in leaves.
"""
...
RECIPE_VARIANT = "tune_iter4_mcw2"
PARAMS_SUMMARY = (
    "XGBRegressor(reg:absoluteerror,n_est=500,lr=0.05,max_depth=6,"
    "min_child_weight=2,subsample=0.8,colsample_bytree=0.8,reg_lambda=1.0,"
    "tree_method=hist,enable_categorical=True),W+mcw2"
)
