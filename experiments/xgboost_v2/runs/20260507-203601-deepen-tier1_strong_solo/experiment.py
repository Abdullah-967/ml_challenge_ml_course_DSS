"""xgboost_v2 tune iter5 -- single knob: min_child_weight=10 (was 5).

Carry-forward: W. More leaf regularization.
"""
...
RECIPE_VARIANT = "tune_iter5_mcw10"
PARAMS_SUMMARY = (
    ...
    "tree_method=hist,enable_categorical=True),W+mcw10"
)
