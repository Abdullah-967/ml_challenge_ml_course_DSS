...
RECIPE_VARIANT = "v2_family_best_lane_a_seed42"
PARAMS_SUMMARY = (
    "RandomForestRegressor(criterion=absolute_error,n_est=200,max_depth=18,"
    "min_samples_leaf=2,max_features=0.4,bootstrap=False,n_jobs=-1,random_state=42),"
    "log1p_target,smooth=10,built_rel_type"
)
...
def fit_predict(train_records, validation_records):
    ...
    model = build_model(numeric_columns, cat_cols, random_state=RF_RANDOM_STATE)
    if USE_LOG_TARGET:
