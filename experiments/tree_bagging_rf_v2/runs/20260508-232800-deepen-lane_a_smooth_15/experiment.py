...
RECIPE_VARIANT = "v2_deepen_iter9_smooth_15"
PARAMS_SUMMARY = (
    "RandomForestRegressor(criterion=absolute_error,n_est=200,max_depth=18,"
    "min_samples_leaf=2,max_features=0.4,bootstrap=False,n_jobs=-1,random_state=42),log1p_target,smooth=15"
)
