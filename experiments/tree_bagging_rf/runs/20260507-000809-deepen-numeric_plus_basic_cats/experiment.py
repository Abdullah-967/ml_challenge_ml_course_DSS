...
RECIPE_VARIANT = "deepen_iter8_add_transaction_type_target_enc"
PARAMS_SUMMARY = (
    "RandomForestRegressor(n_est=200,max_depth=18,min_samples_leaf=2,"
    "max_features=sqrt,n_jobs=-1,random_state=42),log1p_target,"
    "all_numeric+ratios+OHE+commune_te20+cadastral_te20+commune_freq+property_type_te20+transaction_type_te20"
)
USE_LOG_TARGET = True
