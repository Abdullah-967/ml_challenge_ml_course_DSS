...
RECIPE_VARIANT = "deepen_iter10_drop_ohe_cats"
PARAMS_SUMMARY = (
    "RandomForestRegressor(n_est=200,max_depth=18,min_samples_leaf=2,"
    "max_features=sqrt,n_jobs=-1,random_state=42),log1p_target,"
    "all_numeric+ratios+commune_te20+cadastral_te20+commune_freq+property_type_te20+transaction_type_te20+presence_flags (no OHE)"
)
USE_OHE = False
