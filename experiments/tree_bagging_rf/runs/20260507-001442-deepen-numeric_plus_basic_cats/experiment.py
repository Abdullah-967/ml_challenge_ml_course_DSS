...
RECIPE_VARIANT = "tune_iter2_n_est_500"
PARAMS_SUMMARY = (
    "RandomForestRegressor(criterion=absolute_error,n_est=500,max_depth=18,"
    "min_samples_leaf=2,max_features=sqrt,n_jobs=-1,random_state=42),log1p_target"
)
