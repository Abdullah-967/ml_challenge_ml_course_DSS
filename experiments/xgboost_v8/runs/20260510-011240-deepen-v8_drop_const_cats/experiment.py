"""xgboost_v8 deepen iter5 -- drop constant categoricals.

Anchor: deepen iter2 (family-best, v7-equivalent recipe).
Single knob (feature, property_transaction): DROP dept_code, region_code from
CATEGORICAL_COLUMNS. CLAUDE.md flags both as constant across training set, so
they contribute no splits and only add encoding overhead. hypothesis_unit:
...
RECIPE_VARIANT = "deepen_iter5_drop_const_cats"
PARAMS_SUMMARY = (
...
CATEGORICAL_COLUMNS = (
    ...
    # dropped: dept_code, region_code (constant per CLAUDE.md)
)
