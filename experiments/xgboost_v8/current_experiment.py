"""xgboost_v8 deepen anchor -- lane B at restored capacity.

Deepen iter1: lane B winner (room_area_density_ratios, +10 cols) recipe with
n_estimators restored from smoke-shrunk 4000 to 8000 and top_k_types from 10
to 15, matching the v7 promoted capacity. Single knob vs lane B smoke run:
capacity_pair restore.
"""
...
RECIPE_VARIANT = "deepen_iter1_b_density_restored"
PARAMS_SUMMARY = (
    ...
    "+room_area_density_ratios(10cols)"
)
