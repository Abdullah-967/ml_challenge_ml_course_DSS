"""xgboost_v8 deepen iter10 -- compose drop_sparse_rooms with iter7.

Anchor: iter7 (family-best, presence_flags).
Single knob (feature, room_layout): DROP 8 sparse 1-room/2-room raw cols.
hypothesis_unit: `drop_sparse_room_layout`. Tests whether the simplification
that tied at smoke and iter3 also ties or improves at family-best anchor.
"""
...
RECIPE_VARIANT = "deepen_iter10_compose_drop_sparse"
PARAMS_SUMMARY = (
    ...
    "+presence_flags(5),-{1,2}room_layout(8)"
)
