"""xgboost_v8 deepen iter3 -- drop sparse 1-room/2-room raw cols.

Anchor: deepen iter2 (20260509-232317, v7-equivalent recipe in v8 workspace).
Single knob (feature, room_layout): DROP num_apt_1_room, area_apt_1_room,
num_apt_2_rooms, area_apt_2_rooms, num_house_1_room, area_house_1_room,
num_house_2_rooms, area_house_2_rooms (8 cols). hypothesis_unit:
...
RECIPE_VARIANT = "deepen_iter3_drop_sparse_rooms"
PARAMS_SUMMARY = (
