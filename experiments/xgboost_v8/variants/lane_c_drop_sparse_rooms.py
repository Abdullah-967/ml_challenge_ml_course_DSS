"""xgboost_v8 smoke lane C -- drop sparse 1-room/2-room layout columns.

Anchor: xgboost_v7 promoted recipe (top15 sub-models, n_est=8000).
Single knob (feature, room_layout):
  DROP the 8 sparse low-room-count columns:
    num_apt_1_room, area_apt_1_room, num_apt_2_rooms, area_apt_2_rooms,
    num_house_1_room, area_house_1_room, num_house_2_rooms, area_house_2_rooms.
hypothesis_unit: `drop_sparse_room_layout`. Tests whether tail buckets add
noise vs signal at v7's depth/capacity.
"""
...
RECIPE_VARIANT = "smoke_laneC_drop_sparse_room_layout"
PARAMS_SUMMARY = (
    ...
    "-{1room,2rooms}_layout(8cols),smoke_shrink"
)
...
NUMERIC_COLUMNS = (
    ...
    # dropped: area_house_2_rooms, num_house_2_rooms, area_house_1_room, num_house_1_room
    "area_apt_5plus_rooms", "num_apt_5plus_rooms",
    "area_apt_4_rooms", "num_apt_4_rooms",
    "area_apt_3_rooms", "num_apt_3_rooms",
    # dropped: area_apt_2_rooms, num_apt_2_rooms, area_apt_1_room, num_apt_1_room
    "date_ordinal",
