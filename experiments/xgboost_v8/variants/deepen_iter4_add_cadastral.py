"""xgboost_v8 deepen iter4 -- add cadastral counts on top of iter3.

Anchor: deepen iter3 (v7-equivalent minus sparse 1/2-room cols, no density).
Single knob (feature, structural_numeric): ADD num_parcels, num_sections,
num_communes, num_dependencies (4 cadastral counts) to NUMERIC_COLUMNS.
...
RECIPE_VARIANT = "deepen_iter4_add_cadastral"
PARAMS_SUMMARY = (
    ...
    "-{1,2}room_layout,+cadastral_counts(4)"
)
